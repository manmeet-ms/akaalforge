  ...
  return (
    <section ref={sectionRef} className="relative  h-screen   overflow-hidden">
      ...
      <div className=" absolute  inset-0 -z-10">
        ...
        {/* Green overlay to change the background color */}
      </div>
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-start gap-6 px-6 pb-24 pt-8 sm:gap-8 md:pt-12 md:px-10 lg:px-16">
        ...
        <h1 ref={headerRef} className="font-space-mono text-6xl w-[70vw] font-mono font-medium md:-tracking-[12px] md:text-[8rem]   ">
          forge\
          <br />{" "}
          <div className="flex gap-   ">
            <span className="inline">sum</span> <span>ipsum</span>
          </div>{" "}
          umbrella.
        </h1>
