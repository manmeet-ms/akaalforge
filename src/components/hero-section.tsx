...
const Box = ({ position, rotation }) => {
    ...
    shape.absarc(10, 2, radius, angleStep * 0, angleStep * 1);
    shape.absarc(-10, 2, radius, angleStep * 1, angleStep * 2);
    shape.absarc(-10, -2, radius, angleStep * 2, angleStep * 3);
    shape.absarc(10, -2, radius, angleStep * 3, angleStep * 4);
