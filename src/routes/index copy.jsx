  ...
  return (
    <>
      ...
      <main className="px-12 ">
        <section id="why-akaalforge" className="py-12">
          <div className="container">
            <div className="grid gap-9 lg:grid-cols-2">
              <div className="flex flex-col gap-5">
                ...
                <h1 className="text-balance text-4xl font-medium lg:text-5xl">Building Tools That Actually Matter</h1>
                <p className="text-muted-foreground text-lg">We're not here to chase trends or build another SaaS clone. Akaalforge is an umbrella for projects born from real needs—self-tracking that works, preserving knowledge that's fading, and productivity tools that don't get in your way. No fluff, just solutions.</p>
              ...
              <div className="border-border bg-background rounded-2xl border">
                <div className="border-border relative overflow-hidden border-b p-6 lg:px-8 lg:py-11">
                  <div>
                    <h2 className="text-xl font-medium lg:text-2xl">Built From Gut Feeling</h2>
                    <p className="text-muted-foreground mt-2 w-3/4 pr-10 text-sm md:text-base">Every project under Akaalforge started with a problem I faced myself. No market research, no focus groups—just building what needs to exist because nobody else is doing it right.</p>
                    <Button asChild className="mt-4 flex items-center justify-center " variant="secondary"><a href="/about#philosophy">Read our philosophy <IconArrowRightDashed className="inline-flex mt-1.5" /></a></Button>
                  </div>
                ...
                <div className="relative overflow-hidden p-6 lg:px-8 lg:py-11">
                  <div>
                    <h2 className="text-xl font-medium lg:text-2xl">No Sugar Coating</h2>
                    ...
                    <Button asChild className="mt-4 flex items-center justify-center " variant="secondary"><a href="/about#process">See our process <IconArrowRightDashed className="inline-flex mt-1.5" /></a></Button>
                  </div>
                ...
                <div className="border-border relative overflow-hidden border-t p-6 lg:px-8 lg:py-11">
                  <div>
                    <h2 className="text-xl font-medium lg:text-2xl">Purpose Over Profit</h2>
                    ...
                    <Button asChild className="mt-4 flex items-center justify-center " variant="secondary"><a href="#showcase">Explore the projects <IconArrowRightDashed className="inline-flex mt-1.5" /></a></Button>
                  </div>
          ...
          <div className="container grid grid-cols-1 gap-10 lg:grid-cols-3">
            <div className="flex flex-col justify-between lg:col-span-1">
              <div>
                ...
                <p className="text-muted-foreground w-72 text-base tracking-tight">Four apps, four different problems, one philosophy: build what needs to exist. From self-tracking to knowledge preservation, temporary notes to meal planning—each one born from necessity, not novelty.</p>
              </div>
              ...
              {services.slice(0, 2).map((service, idx) => (
                <motion.a key={idx} href={service.url} whileHover={{ opacity: 0.8 }} className="group block overflow-hidden rounded-xl">
                  <Card className="relative aspect-3/4 overflow-hidden p-0">
                    ...
                    <div className="absolute inset-0 h-full w-full   flex items-center justify-center "><IconDrone className=" hover:text-lime-100 h-64 w-64 object-cover text-primary " stroke={0.5} /></div>
                ...
                {services.slice(2).map((service, idx) => (
                  <motion.a key={idx + 2} href={service.url} whileHover={{ opacity: 0.8 }} className="group block overflow-hidden rounded-xl">
                    <Card className="relative aspect-[4/3] overflow-hidden p-0">
                      {/* <img src={service.image} alt={service.title} className="absolute inset-0 h-full w-full object-cover" /> */}
                    <div className="absolute inset-0 h-full w-full   flex items-center justify-center "><IconDrone className=" hover:text-lime-100 h-24 w-24 object-cover text-primary " stroke={0.5} /></div>
        ...
        <section id="impact" className="py-20 mb-10">
          <div className="container flex flex-col items-center text-left">
              <h2 className="mb-12 md:mb-16 text-center w-full text-pretty text-3xl sm:text-4xl lg:text-6xl">Built & Shipped</h2>
            <div className="grid w-full grid-cols-2 gap-12 sm:w-fit sm:grid-cols-4 lg:gap-16">
              <div className="w-full flex flex-col items-center">
                ...
                <div className="font-thin text-center text-accent-foreground/60 text-base leading-6 lg:text-lg">Live Projects</div>
              </div>
              <div className="w-full flex flex-col items-center">
                <div className="mb-2 text-4xl text-center font-semibold sm:text-4xl lg:text-5xl">2025</div>
                <div className="font-thin text-center text-accent-foreground/60 text-base leading-6 lg:text-lg">Year Founded</div>
              </div>
              <div className="w-full flex flex-col items-center">
            ...
            <div className="container mx-auto">
              <div className="flex flex-col text-center   rounded-md p-4 lg:p-14 gap-8 items-center">
                ...
                <div className="flex flex-row gap-4">
                 ...
                 <Link to="/contact"> <Button className="flex justify-center items-center ">
