...
import { IconCircle, IconCircle0, IconCircleFilled, IconDots } from '@tabler/icons-react'
...
function RouteComponent({
  ...
  email = "contact@akaalforge.com",
  web = { label: "akaalforge.com", url: "https://akaalforge.com" },
}) {
          ...
          <div className="mx-auto flex max-w-sm flex-col justify-between gap-10">
            <div className="text-center lg:text-left">
              <h1 className="mb-2 text-5xl font-semibold lg:mb-1 lg:text-6xl">
                {title}<IconCircleFilled className='inline-flex -ml-2 -mb-4  items-center justify-center text-primary ' size={32} />
              </h1>
